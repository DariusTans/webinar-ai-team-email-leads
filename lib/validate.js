...
export function validate(body) {
  ...
  // ชื่อต้องไม่สื่อความหมาย (ห้าม company/address/phone) ไม่งั้น autofill ของ Chrome
  // จะกรอกให้คนจริงแล้วโดนตัดสินว่าเป็นบอท — ดู index.html ที่ div.hp
  if (str(input.hp_zzz)) return { ok: false, spam: true, errors: {}, data: null };
